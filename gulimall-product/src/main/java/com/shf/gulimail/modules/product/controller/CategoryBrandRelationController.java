...
import com.shf.gulimail.modules.product.dto.CategoryBrandRelationDTO;
import com.shf.gulimail.modules.product.excel.CategoryBrandRelationExcel;
import com.shf.gulimail.modules.product.service.CategoryBrandRelationService;
...
public class CategoryBrandRelationController {
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    // @RequiresPermissions("gulimail:categorybrandrelation:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    // @RequiresPermissions("gulimail:categorybrandrelation:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    // @RequiresPermissions("gulimail:categorybrandrelation:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    // @RequiresPermissions("gulimail:categorybrandrelation:export")
