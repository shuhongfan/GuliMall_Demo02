...
import com.shf.gulimail.modules.product.excel.SpuCommentExcel;
...
public class SpuCommentController {
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    // @RequiresPermissions("gulimail:spucomment:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    // @RequiresPermissions("gulimail:spucomment:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    // @RequiresPermissions("gulimail:spucomment:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    // @RequiresPermissions("gulimail:spucomment:export")
