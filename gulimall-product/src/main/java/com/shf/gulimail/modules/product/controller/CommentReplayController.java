...
import com.shf.gulimail.modules.product.excel.CommentReplayExcel;
...
public class CommentReplayController {
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    // @RequiresPermissions("gulimail:commentreplay:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    // @RequiresPermissions("gulimail:commentreplay:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    // @RequiresPermissions("gulimail:commentreplay:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    // @RequiresPermissions("gulimail:commentreplay:export")
