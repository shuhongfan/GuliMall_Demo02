...
import com.shf.gulimail.modules.product.excel.SkuSaleAttrValueExcel;
...
public class SkuSaleAttrValueController {
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    // @RequiresPermissions("gulimail:skusaleattrvalue:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    // @RequiresPermissions("gulimail:skusaleattrvalue:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    // @RequiresPermissions("gulimail:skusaleattrvalue:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    // @RequiresPermissions("gulimail:skusaleattrvalue:export")
