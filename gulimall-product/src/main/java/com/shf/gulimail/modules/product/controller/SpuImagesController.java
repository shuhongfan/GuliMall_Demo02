...
import com.shf.gulimail.modules.product.dto.SpuImagesDTO;
import com.shf.gulimail.modules.product.excel.SpuImagesExcel;
import com.shf.gulimail.modules.product.service.SpuImagesService;
...
public class SpuImagesController {
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    // @RequiresPermissions("gulimail:spuimages:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    // @RequiresPermissions("gulimail:spuimages:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    // @RequiresPermissions("gulimail:spuimages:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    // @RequiresPermissions("gulimail:spuimages:export")
