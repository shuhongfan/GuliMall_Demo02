...
import com.shf.gulimail.modules.product.dto.AttrDTO;
import com.shf.gulimail.modules.product.excel.AttrExcel;
import com.shf.gulimail.modules.product.service.AttrService;
...
public class AttrController {
    ...
    @ApiOperation("保存")
    @LogOperation("保存")
    // @RequiresPermissions("gulimail:attr:save")
    ...
    @ApiOperation("修改")
    @LogOperation("修改")
    // @RequiresPermissions("gulimail:attr:update")
    ...
    @ApiOperation("删除")
    @LogOperation("删除")
    // @RequiresPermissions("gulimail:attr:delete")
    ...
    @ApiOperation("导出")
    @LogOperation("导出")
    // @RequiresPermissions("gulimail:attr:export")
